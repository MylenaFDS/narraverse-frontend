...
function normalizeNotification(n: unknown): Notification {
  ...
  return {
    ...
    meta: {
      turn_id:
        typeof meta.turn_id === "number"
          ? meta.turn_id
          : undefined,

      rpg_id:
        typeof meta.rpg_id === "number"
          ? meta.rpg_id
          : undefined,

      isNew:
        typeof meta.isNew === "boolean"
          ? meta.isNew
          : false,
    },
  }
...
export function NotificationProvider({
  ...
  const STORAGE_KEY = `notifications_${userId ?? "guest"}`
  ...
  // 🔥 salva somente do usuário atual
  useEffect(() => {
